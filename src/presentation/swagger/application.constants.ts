export class SwaggerConstants {
  ...
  public static readonly SWAGGER_TITLE: string = '🍔 Fast & Foodious API - Produto';
  ...
  public static readonly SWAGGER_EXTERNAL_DOC_URL: string = 'https://github.com/rs-renato/fast-n-foodious-ms-produto';
}
