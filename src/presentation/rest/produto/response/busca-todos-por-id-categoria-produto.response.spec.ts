import { BuscaTodosPorIdCategoriaProdutoResponse } from './busca-todos-por-id-categoria-produto.response';
import { Produto } from 'src/enterprise/produto/model/produto.model';

describe('BuscaTodosPorIdCategoriaProdutoResponse', () => {
  it('deve setar as propriedades corretamente', () => {
    ...
    const produtoResponse = new BuscaTodosPorIdCategoriaProdutoResponse(produto);
